import json
from coguard_coverity_translator.json_translator import translate_result_json
...
def entrypoint(args):
    ...
    with path_to_folder.joinpath('result_coverity.json').open(mode='w', encoding='utf-8') as cov_result:
        json.dump(
